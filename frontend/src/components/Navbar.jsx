...
//               </div>
//               <h1 className="text-lg font-bold">Talklet</h1>
//             </Link>
//           </div>
...
const Navbar = () => {
  ...
  return (
    <header className="bg-base-100 border-b border-base-300 fixed w-full top-0 z-40 backdrop-blur-md bg-base-100/80 shadow-sm">
      <div className="container mx-auto px-4 h-16">
        <div className="flex items-center justify-between h-full">
          {/* Logo */}
          ...
          <div className="flex items-center gap-2">
            ...
            {authUser && (
              <>
                ...
                <button className="btn btn-sm btn-error text-white gap-2" onClick={logout}>
                  <LogOut className="size-5" />
                  <span className="hidden sm:inline">Logout</span>
                </button>
              </>
